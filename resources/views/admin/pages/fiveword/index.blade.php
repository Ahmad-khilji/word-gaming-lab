    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="savefiveWord()" id="saveCategoryLoader">Save Five Word</button>
                <button style="display: none;" type="button" class="btn btn-primary" onclick="updatefiveWord()" id="updateCategoryLoader">Update hree Word</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="editCategoryModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" onclick="updatefiveWord()" id="updateCategoryLoader">Update Five Word</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="deletefiveWord()" id="deleteCategoryLoader">Yes</button>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="mt-3 mb-3">
                            <button data-bs-toggle="modal" data-bs-target="#createNewCategory" type="button" name="button" class="btn btn-primary">Create New Five Word</button>
                        </div>
                    </div>
