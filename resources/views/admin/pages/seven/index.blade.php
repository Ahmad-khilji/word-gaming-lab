        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="deletesevenWord()"
    ...
    <script>
        document.getElementById("importCsvBtn").addEventListener("click", function() {
            Swal.fire({
                ...
                html: `
            <img src="{{ asset('admin/assets/img/sevenword.png') }}" alt="Upload Image" class="mb-3 w-100 object-fit-cover">
