...
@section('title')
Admin Dashboard | WOrd Gamin Lab
@endsection
@section('content')
...
<div class="pagetitle">
    ...
    {{-- <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Six Word Game</li>
        </ol>
    </nav> --}}
</div><!-- End Page Title -->
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="savesevenWord()" id="saveCategoryLoader">Save Seven Word</button>
                <button style="display: none;" type="button" class="btn btn-primary" onclick="updatesevenWord()" id="updateCategoryLoader">Update Seven Word</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="editCategoryModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" onclick="updatesevenWord()" id="updateCategoryLoader">Update Seven Word</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="deletesevenWord()" id="deleteCategoryLoader">Yes</button>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="mt-3 mb-3">
                            <button data-bs-toggle="modal" data-bs-target="#createNewCategory" type="button" name="button" class="btn btn-primary">Create New Seven Word</button>
                        </div>
                    </div>
...
<script>
    ...
    table = $('#category-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route("super_admin.sevenword.index") }}',
            type: 'GET',
    ...
    function savesevenWord() {
        ...
        let url = "{{ route('super_admin.sevenword.store') }}";
    ...
    function updatesevenWord() {
        ...
        let routeTemplate = "{{ route('super_admin.sevenword.update', ['id' => ':id']) }}";
    ...
    function deleteModal(id, name) {
        ...
        $('#category_del_title').text('Are You Sure you want to delete this Seven Word?' + ' ' + name);
        $('#deleteCategory').modal('show');
    }

    function deletesixWord() {
        $('#deleteCategoryLoader').addClass('loading');
        let dataId = $('#deleteCategoryLoader').attr("data-id");
        let url = "{{ route('super_admin.sevenword.delete') }}";
        $.ajax({
            type: "post",
            url: url,
            data: {
